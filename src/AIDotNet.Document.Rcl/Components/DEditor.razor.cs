...
public partial class DEditor: MasaComponentBase
{
    ...
    private DotNetObjectReference<DEditor>? _objRef;
    ...
    public async Task CreateEditorAsync()
    {
        ...
        _quillHelper =
            await Js.InvokeAsync<IJSObjectReference>("import", "./_content/AIDotNet.Document.Rcl/js/quill-helper.js");
