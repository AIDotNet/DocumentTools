...
public class DMarkdown : Container
{
    ...
    private DotNetObjectReference<DMarkdown>? _objRef;
    ...
    public async Task CreateMarkdownAsync()
    {
        ...
        _vditorHelper =
            await Js.InvokeAsync<IJSObjectReference>("import", "./_content/AIDotNet.Document.Rcl/js/vditor-helper.js");
