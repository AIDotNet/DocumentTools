...
public partial class Setting
{
    ...
    public override async Task SetParametersAsync(ParameterView parameters)
    {
        ...
        Type = type switch
        {
            Constant.Settings.SettingsType => Constant.Settings.SettingsType,
            Constant.Settings.AboutType => Constant.Settings.AboutType,
            _ => Constant.Settings.SettingsType
        };
    }
    ...
    protected override void OnInitialized()
    {
        ...
        _embeddings =
        [
            new("text-embedding-3-large"), new("text-embedding-3-small"), new("text-embedding-ada-002"),
            new("text-embedding-v1"), new("text-moderation-latest"), new("text-moderation-stable"),
